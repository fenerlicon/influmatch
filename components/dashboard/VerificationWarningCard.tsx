...
export default function VerificationWarningCard() {
    ...
    return (
        ...
        >
            ...
            <h3 className="text-lg font-semibold text-white">Hesabınızı Onaylatın & Mavi Tik Kazanın</h3>
            <p className="mt-2 text-sm text-gray-400 max-w-xs">
                Mavi Tik rozetine sahip olmak ve profilinizin güvenilirliğini kanıtlamak için verilerinizi doğrulamanız gerekmektedir.
            </p>
