  ...
  return (
    <header className="border-b border-white/5 bg-[#101117]/80 px-4 py-4 text-white backdrop-blur lg:px-10">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <p className="text-xs uppercase tracking-[0.4em] text-soft-gold">Dashboard</p>
          <h1 className="mt-1 text-xl font-semibold">{fullName}</h1>
          <p className="text-sm text-gray-400">{USER_ROLE_LABELS[role]} hesabı</p>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-sm text-gray-300 sm:flex-row sm:items-center">
          ...
          <span className="text-xs uppercase tracking-[0.3em] text-gray-400">Dark Premium</span>
        </div>
      </div>
    </header>
  )
